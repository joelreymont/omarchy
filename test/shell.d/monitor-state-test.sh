...
extended='[
  { "name": "eDP-1", "description": "BOE 0x0A4F", "mirrorOf": "none", "disabled": false, "focused": false, "width": 1920, "height": 1080, "scale": 2 },
  { "name": "DP-1", "description": "Dell U2723QE ABC123", "mirrorOf": "none", "disabled": false, "focused": true, "width": 2560, "height": 1440, "scale": 1.5 }
]'
...
clamshell='[
  { "name": "eDP-1", "description": "BOE 0x0A4F", "mirrorOf": "none", "disabled": true, "focused": false, "width": 0, "height": 0, "scale": 2 },
  { "name": "DP-1", "description": "Dell U2723QE ABC123", "mirrorOf": "none", "disabled": false, "focused": true, "width": 2560, "height": 1440, "scale": 1.5 }
]'
...
monitor_state "$extended"
[[ ${state_lines[7]-} == '[{"name":"eDP-1","description":"BOE 0x0A4F","enabled":true,"focused":false,"width":1920,"height":1080,"scale":2},{"name":"DP-1","description":"Dell U2723QE ABC123","enabled":true,"focused":true,"width":2560,"height":1440,"scale":1.5}]' ]] ||
  fail "monitor state lists every display for the panel" "actual: ${state_lines[7]-<missing>}"
monitor_state "$clamshell"
[[ ${state_lines[7]-} == '[{"name":"eDP-1","description":"BOE 0x0A4F","enabled":false,"focused":false,"width":0,"height":0,"scale":2},{"name":"DP-1","description":"Dell U2723QE ABC123","enabled":true,"focused":true,"width":2560,"height":1440,"scale":1.5}]' ]] ||
  fail "monitor state lists every display for the panel" "actual: ${state_lines[7]-<missing>}"
pass "monitor state lists every display with its own description and scale, enabled and focused state"
